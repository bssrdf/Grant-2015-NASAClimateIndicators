...
This proposal will award \$2800 per year to Colin Zarzycki (National Center for Atmospheric Research), covering annual travel expenses to the American Geophysical Union (AGU) Fall Meeting (\$1600 per year) and one trip to UC Davis for consultation / in-person meetings (\$1200 per year).
